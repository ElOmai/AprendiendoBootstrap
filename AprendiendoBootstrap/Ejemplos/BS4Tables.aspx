<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BS4Tables.aspx.cs" Inherits="AprendiendoBootstrap.Ejemplos.BS4Tables" %>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>Juan</td>
                            <td>Pérez</td>
                            <td>JuanPérez@aplicada2.com</td>
                        </tr>
                        <tr>
                            <td>Luis Miguel</td>
                            <td>Martínez</td>
                            <td>LuisMiguelMartínez@aplicada2.com</td>
                        </tr>
                        <tr>
                            <td>José</td>
                            <td>Ramírez</td>
                            <td>JoséRamírez@aplicada2.com</td>
                        </tr>
                    </tbody>
                </table>
